...
const MovieDetails = () => {
  ...
  <View className="flex-row items-center gap-x-1 mt-2">
    ...
    <Text className="text-light-200 text-sm">{movie.runtime ? `${movie.runtime}min` : 'N/A'}</Text>
  </View>
  <View className="flex-row items-center bg-dark-100 px-2 py-1 rounded-md gap-x-1 mt-2">
  <Image source={icons.star} className="size-4" />
  <Text className="text-white font-bold text-sm">{Math.round(movie.vote_average || 0)}/10
  </Text>
